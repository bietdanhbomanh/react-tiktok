export function UpdateIcon({ className, width = 24, height = 24 }) {
    return (
        <svg
            className={className}
            width={width}
...
export function SearchIcon({ className, width = 24, height = 24 }) {
    return (
        <svg
            className={className}
            width={width}
...
export function FlyIcon({ className, width = 24, height = 24 }) {
    return (
        <svg
            className={className}
            width={width}
...
export function MessageIcon({ className, width = 24, height = 24 }) {
    return (
        <svg
            className={className}
            width={width}
